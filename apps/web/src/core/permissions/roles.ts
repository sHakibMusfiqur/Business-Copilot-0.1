...
const baseFinanceWidgets: RoleProfile['widgets'] = [
  { key: 'metricCurrency', zone: 'hero', span: 3, source: 'monthlyRevenue', permission: ['invoices.read', 'accounting.read', 'accounting.accounts.read', 'payments.read'] },
  { key: 'metricCurrency', zone: 'hero', span: 3, source: 'netProfit', permission: ['invoices.read', 'accounting.read', 'accounting.accounts.read', 'payments.read'] },
  { key: 'metricCurrency', zone: 'hero', span: 3, source: 'cashBalance', permission: ['invoices.read', 'accounting.read', 'accounting.accounts.read', 'payments.read'] },
  { key: 'metricCurrency', zone: 'hero', span: 3, source: 'outstanding', permission: ['invoices.read', 'accounting.read', 'accounting.accounts.read', 'payments.read'] },
  { key: 'trend', zone: 'charts', span: 8, source: 'revenue', permission: ['invoices.read', 'accounting.read', 'accounting.accounts.read', 'payments.read'] },
  { key: 'cashFlow', zone: 'charts', span: 4, permission: ['invoices.read', 'accounting.read', 'accounting.accounts.read', 'payments.read'] },
  { key: 'forecast', zone: 'charts', span: 12, source: 'forecast', permission: ['invoices.read', 'accounting.read', 'accounting.accounts.read', 'payments.read'] },
...
export const ROLE_PROFILES: Record<RoleKey, RoleProfile> = {
  ...
  ceo: {
    ...
    widgets: [
      { key: 'metricCurrency', zone: 'hero', span: 4, source: 'monthlyRevenue', permission: ['invoices.read', 'accounting.read', 'accounting.accounts.read', 'payments.read'] },
      { key: 'metricCurrency', zone: 'hero', span: 4, source: 'netProfit', permission: ['invoices.read', 'accounting.read', 'accounting.accounts.read', 'payments.read'] },
  ...
  guest: {
    ...
    widgets: [
      { key: 'metric', zone: 'hero', span: 4, source: 'monthlyRevenue', permission: ['invoices.read', 'accounting.read', 'accounting.accounts.read', 'payments.read'] },
      { key: 'metric', zone: 'hero', span: 4, source: 'openOrders' },
      { key: 'metric', zone: 'hero', span: 4, source: 'employees' },
      { key: 'trend', zone: 'charts', span: 12, source: 'revenue', permission: ['invoices.read', 'accounting.read', 'accounting.accounts.read', 'payments.read'] },
    ],
